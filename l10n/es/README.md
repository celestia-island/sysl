...
**La primera licencia de código abierto diseñada para software cuyo código es 100% generado por IA.**
...
|----------|--------|---------|-----|
| English (vinculante) | [README.md](./README.md) | [LICENSE.txt](./LICENSE.txt) | [FAQ.md](./FAQ.md) |
