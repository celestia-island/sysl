...
**Die erste Open-Source-Lizenz, die für Software konzipiert wurde, deren Code zu 100 % KI-generiert ist.**
...
| Sprache | README | LICENSE | FAQ |
|---------|--------|---------|-----|
| English (verbindlich) | [README.md](./README.md) | [LICENSE.txt](./LICENSE.txt) | [FAQ.md](./FAQ.md) |
