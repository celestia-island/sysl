...
| **分層授權** | 可與 BUSL-1.1 共存以提供商業保護（雙重授權） |
...
| 語言 | README | LICENSE | FAQ | COMPARISON |
|----------|--------|---------|-----|------------|
| English（約束力） | [README.md](../../README.md) | [LICENSE.txt](../../LICENSE.txt) | [FAQ.md](../../FAQ.md) | [COMPARISON.md](../../COMPARISON.md) |
