...
**코드가 100% AI로 생성된 소프트웨어를 위해 설계된 최초의 오픈소스 라이선스.**
...
2026년, AI 모델은 일상적으로 전체 코드베이스를 생성합니다. [](https://github.com/celestia-island/) 프로젝트---멀티 에이전트 AI 오케스트레이션 플랫폼---는 85만 줄 이상의 Rust 코드, 56개 크레이트, 2,200개 이상의 테스트로 구성된 100% AI 생성 코드베이스입니다. 한 사람이 1,000억 개의 토큰을 사용하여 4.3개월 만에 완성했습니다.
...
| 언어 | README | LICENSE | FAQ |
|----------|--------|---------|-----|
| English (구속력 있음) | [README.md](./README.md) | [LICENSE.txt](./LICENSE.txt) | [FAQ.md](./FAQ.md) |
...
| 프로젝트 | 설명 | 도입 시기 |
|---------|-------------|-------|
| [](https://github.com/celestia-island/) | 멀티 에이전트 AI 오케스트레이션 플랫폼 | 2026-06 |
